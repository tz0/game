 ...
 */
    ...
    std::shared_ptr<Entity> EntityFactory::MakeResourceTracker(const sf::Vector2f &size, float max_value, std::string &texture_path) {
        ...
        sprite.setTextureRect(sf::IntRect(0, 0, (int)(size.x), (int)(size.y / 2)));
